...
const cases = [
	{
		path: '/Users/richu/programming/nova/src/routes/dashboard/settings/+page.svelte',
		literals: ['Redirecting to settings...']
	},
	{
		path: '/Users/richu/programming/nova/src/routes/dashboard/settings/profile/+page.svelte',
		literals: ['Settings', 'Account Details', 'Display Name', 'Change Password', 'Save Name']
	},
	{
		path: '/Users/richu/programming/nova/src/routes/dashboard/settings/system/+page.svelte',
		literals: ['System Config', 'Pricing Configuration', 'Currency Formatting', 'Barcode Features', 'Save Settings']
	},
	{
		path: '/Users/richu/programming/nova/src/routes/dashboard/settings/users/+page.svelte',
		literals: ['Settings / Admin', 'User Management', 'Create New User', 'Add User', 'No users found']
	},
	{
		path: '/Users/richu/programming/nova/src/routes/dashboard/settings/backup/+page.svelte',
